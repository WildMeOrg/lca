...
# Base paths
config_base = "/users/PAS2136/nepove/code/lca/beta_stability/configs"
...
def generate_hdbscan_config(species_dir, species_name):
    ...
    config = {
        ...
        'logging': {
            'log_level': 'INFO',
            'log_file': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/output/hdbscan_output.log',
...
def generate_gc_config(species_dir, species_name):
    ...
    config = {
        ...
        'logging': {
            'log_level': 'INFO',
            'log_file': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/output/gc_output_theta_005_metadata.log',
            'update_log_file': True,
            'file_mode': 'w',
            'auto_threshold_plot_path': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/hist/gc_hist.png'
        },
        'gc': {
            'verifier_name': 'miewid',
            'theta': 0.05,
...
def generate_manual_review_config(species_dir, species_name):
    ...
    config = {
        ...
        'data': {
            ...
            'annotation_file': f'/fs/ess/PAS2136/ggr_data/kate/data_embeddings/{species_dir}/annotations_{species_dir}.json',
            'embedding_file': f'/fs/ess/PAS2136/ggr_data/kate/data_embeddings/{species_dir}/embeddings_{species_dir}.pickle',
            'output_path': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/manual_review_clustering/',
            'separate_viewpoints': False
        },
        'edge_weights': {
        ...
        'logging': {
            'log_level': 'INFO',
            'log_file': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/output/manual_review_output.log',
            'update_log_file': True,
            'file_mode': 'w'
        },
        'gc': {
...
def generate_thresholded_review_config(species_dir, species_name):
    ...
    config = {
        ...
        'data': {
            ...
            'annotation_file': f'/fs/ess/PAS2136/ggr_data/kate/data_embeddings/{species_dir}/annotations_{species_dir}.json',
            'embedding_file': f'/fs/ess/PAS2136/ggr_data/kate/data_embeddings/{species_dir}/embeddings_{species_dir}.pickle',
            'output_path': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/thresholded_output/',
            'separate_viewpoints': False
        },
        'edge_weights': {
            'prob_human_correct': 1.0,
        ...
        'logging': {
            'log_level': 'INFO',
            'log_file': f'/users/PAS2136/nepove/code/lca/beta_stability/tmp/{species_dir}/thresholded_review_output.log',
            'update_log_file': True,
            'file_mode': 'w'
        },
        'gc': {
