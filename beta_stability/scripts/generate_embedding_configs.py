...
CONFIGS_DIR = Path('/users/PAS2136/nepove/code/lca/beta_stability/configs')
RUN_SCRIPT = Path('/users/PAS2136/nepove/code/lca/beta_stability/run_baselines_embedding.sh')
SBATCH_SCRIPT = Path('/users/PAS2136/nepove/code/lca/beta_stability/sbatch/sbatch_baselines_embedding.sh')
